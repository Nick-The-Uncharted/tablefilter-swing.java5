...
/**
 * Variation of Bug1_4_0MissingFilterHeader. It codes the 'normal' setup -table
 * and header created/populated before any additional containment operation-
...
public class Bug1_4_0MissingFilterHeaderAltD_Ok extends JPanel {
    ...
    public static void main(String args[]) {
        Bug1_4_0MissingFilterHeaderAltD_Ok testTableFilter =
            new Bug1_4_0MissingFilterHeaderAltD_Ok();
